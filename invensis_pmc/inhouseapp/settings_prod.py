...
APPLICATION_URL = 'http://121.243.46.160'
APPLICATION_CONFIG = {
    'title': _('Inhouseapp'),
    'short_title': _('EP'),
    ...
    'copyright': "&copy; {} <a href='http://invensis.net'>Invensis.</a>".format(datetime.now().year),
...
SUIT_CONFIG = {
    ...
    # menu
     ...
     'MENU': (
        ...
        {'app': 'project','label': 'Projects', 'icon': 'icon-folder-open', 'models': (
            {'model': 'project.project', 'label': 'Projects',},

            {'model': 'project.industry', 'label': 'Industry', },
            {'model': 'project.service', 'label': 'Service'},
            {'model': 'project.projectservice', 'label': 'ProjectServices',},
            ...
            {'model': 'project.workitemstatus', 'label': 'WorkItemStatuss', },
            {'model': 'project.qcstatus', 'label': 'QcStatuss', },

            {'model': 'project.ProjectTaskTemplate', 'label': 'ProjectTaskTemplate',},

            {'model': 'project.ProjectWorkItemTemplate', 'label': 'ProjectWorkItemTemplate', },
